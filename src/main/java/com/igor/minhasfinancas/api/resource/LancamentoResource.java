...
import com.igor.minhasfinancas.api.dto.AtualizarStatusDto;
import com.igor.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	//Eliminando dependendia do construtor
	...
	//atualizar recurso q não esta no servidor
	//esta recebendo um dto pois vem um json como parametro
	@PutMapping("{id}")
	...
	public ResponseEntity atualizarStatus(@PathVariable  ("id")Long id, @RequestBody AtualizarStatusDto dto) {
		return service.obterPorId(id).map(Entity -> {
			...
			if(statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Não foi possível atualizar o status do lancamento, envie um status valido");	
			}
