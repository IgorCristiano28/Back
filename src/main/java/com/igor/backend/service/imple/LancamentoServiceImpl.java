...
import com.igor.backend.model.repository.LancamentoRepository;
import com.igor.backend.service.LancamentoService;

//como ele é um bin gerenciavel se ele estiver uma instancia não precisa colocar waltorire
@Service
public class LancamentoServiceImpl implements LancamentoService {
	
	//criar a dependencia do lancamento repository criado na camada de modelo.
	...
	@Override
	@Transactional  //vai abrir uma transação no nosso metodo e fazer um commit se estiver ok ou rolback
	...
	public List<Lancamento> buscar(Lancamento lancamentoFiltro) {
		 ...
		 * 
		 * if(lancamentoFiltro.getDescricao() != null) { sql = sql + "and descricao =  "
	...
	public void validar(Lancamento lancamento) {
		...
		if(lancamento.getUsuario() == null || lancamento.getUsuario().getId() == null) {
			throw new RegraNegocioException("Informe um Usário Valido.");
