...
public class ViagemDTO {
    ...
    private List<ChecklistDTOCMS> checklistsCMS;
    
    // Construtor que inicializa a lista
    public ViagemDTO() {
        this.checklistsCMS = new ArrayList<>();
    }
	...
	public List<ChecklistDTOCMS> getChecklistsCMS() {
		return checklistsCMS;
	}
	public void setChecklistsCMS(List<ChecklistDTOCMS> checklistsCMS) {
		this.checklistsCMS = checklistsCMS;
	}
